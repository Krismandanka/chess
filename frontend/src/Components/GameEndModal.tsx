...
const PlayerDisplay = ({
    ...
    return (
        <div className="flex flex-col items-center">
            ...
            <div className="text-center text-xm p-2">
                <p className="text-white truncate w-24" >
                    {player}
                </p>
            </div>
        </div>
...
const GameEndModal = ({ win, whitePlayer, blackPlayer, setWinModal }: { win: string | null, whitePlayer: string | undefined | null, blackPlayer: string | undefined | null, setWinModal: any }) => {
                ...
                <div className="relative rounded-lg shadow-lg bg-gray-800 w-96">
                    <div className="px-6 py-8 items-center self-center m-auto">
                        <div className="m-auto mb-6">
                            <h2 className={`text-4xl font-bold mb-2 text-yellow-400 text-center text-wrap`}>
                                {
                                    win === "White" ? "White Wins!" : "Black Wins!"

                                }
                            </h2>
                        </div>
                        <div className="m-auto mb-6">
                            <p className="text-xl text-white text-center">by </p>
                        </div>
                        <div className="flex flex-row justify-between items-center bg-gray-700 rounded-lg px-4 py-6">
                            <PlayerDisplay isWhite={true} player={whitePlayer} gameResult={win === "White" ? true : false} />
                            <div className="text-white text-2xl font-bold">vs</div>
                            <PlayerDisplay isWhite={false} player={blackPlayer} gameResult={win === "Black" ? true : false} />
                        </div>
                    </div>
                    <div className="px-6 py-4 bg-gray-900 text-right rounded-b-lg">
                        <button
